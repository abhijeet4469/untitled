(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlin-wrappers-kotlin-react-dom-js-legacy', 'is-sorted', 'mathjs', 'kotlin-wrappers-kotlin-styled-js-legacy', 'kotlinx-html-js', 'kotlin-wrappers-kotlin-react-js-legacy', 'kotlin-css'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlin-wrappers-kotlin-react-dom-js-legacy'), require('is-sorted'), require('mathjs'), require('kotlin-wrappers-kotlin-styled-js-legacy'), require('kotlinx-html-js'), require('kotlin-wrappers-kotlin-react-js-legacy'), require('kotlin-css'));
  else {
    if (typeof kotlin === 'undefined') {
      ...
      throw new Error("Error loading module 'untitled'. Its dependency 'mathjs' was not found. Please, check whether 'mathjs' is loaded prior to 'untitled'.");
    ...
    }root.untitled = factory(typeof untitled === 'undefined' ? {} : untitled, kotlin, this['kotlin-wrappers-kotlin-react-dom-js-legacy'], sorted123, log, this['kotlin-wrappers-kotlin-styled-js-legacy'], this['kotlinx-html-js'], this['kotlin-wrappers-kotlin-react-js-legacy'], this['kotlin-css']);
  }
}(this, function (_, Kotlin, $module$kotlin_wrappers_kotlin_react_dom_js_legacy, $module$is_sorted, $module$mathjs, $module$kotlin_wrappers_kotlin_styled_js_legacy, $module$kotlinx_html_js, $module$kotlin_wrappers_kotlin_react_js_legacy, $module$kotlin_css) {
  'use strict';
  ...
  function main() {
    ...
    console.log($module$is_sorted([3, 4, 5]));
    console.log('Sqrt of : ', $module$mathjs(10000, 10));
  }
