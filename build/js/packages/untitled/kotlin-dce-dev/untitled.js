(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'is-sorted', 'string', 'kotlin-wrappers-kotlin-styled-js-legacy', 'kotlinx-html-js', 'kotlin-wrappers-kotlin-react-dom-js-legacy', 'kotlin-wrappers-kotlin-react-js-legacy', 'kotlin-css'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('is-sorted'), require('string'), require('kotlin-wrappers-kotlin-styled-js-legacy'), require('kotlinx-html-js'), require('kotlin-wrappers-kotlin-react-dom-js-legacy'), require('kotlin-wrappers-kotlin-react-js-legacy'), require('kotlin-css'));
  else {
    if (typeof kotlin === 'undefined') {
      ...
      throw new Error("Error loading module 'untitled'. Its dependency 'is-sorted' was not found. Please, check whether 'is-sorted' is loaded prior to 'untitled'.");
    }if (typeof string === 'undefined') {
      throw new Error("Error loading module 'untitled'. Its dependency 'string' was not found. Please, check whether 'string' is loaded prior to 'untitled'.");
    }if (typeof this['kotlin-wrappers-kotlin-styled-js-legacy'] === 'undefined') {
      throw new Error("Error loading module 'untitled'. Its dependency 'kotlin-wrappers-kotlin-styled-js-legacy' was not found. Please, check whether 'kotlin-wrappers-kotlin-styled-js-legacy' is loaded prior to 'untitled'.");
      ...
      throw new Error("Error loading module 'untitled'. Its dependency 'kotlin-wrappers-kotlin-react-dom-js-legacy' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-dom-js-legacy' is loaded prior to 'untitled'.");
    }if (typeof this['kotlin-wrappers-kotlin-react-js-legacy'] === 'undefined') {
      throw new Error("Error loading module 'untitled'. Its dependency 'kotlin-wrappers-kotlin-react-js-legacy' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-js-legacy' is loaded prior to 'untitled'.");
    }if (typeof this['kotlin-css'] === 'undefined') {
      throw new Error("Error loading module 'untitled'. Its dependency 'kotlin-css' was not found. Please, check whether 'kotlin-css' is loaded prior to 'untitled'.");
    }root.untitled = factory(typeof untitled === 'undefined' ? {} : untitled, kotlin, sorted, string, this['kotlin-wrappers-kotlin-styled-js-legacy'], this['kotlinx-html-js'], this['kotlin-wrappers-kotlin-react-dom-js-legacy'], this['kotlin-wrappers-kotlin-react-js-legacy'], this['kotlin-css']);
  }
}(this, function (_, Kotlin, $module$is_sorted, $module$string, $module$kotlin_wrappers_kotlin_styled_js_legacy, $module$kotlinx_html_js, $module$kotlin_wrappers_kotlin_react_dom_js_legacy, $module$kotlin_wrappers_kotlin_react_js_legacy, $module$kotlin_css) {
  'use strict';
  ...
  function main$getStringName(name) {
    return (new $module$string(name)).left(3);
  }
  function main() {
    println('Hello this is kotlin syntax');
    console.log('Hello, Kotlin/JS!');
    console.log($module$is_sorted([1, 2, 3]));
    console.log($module$is_sorted([3, 1, 2]));
    console.log((new $module$string('Abhi')).right(2));
    console.log((new $module$string('Abhi')).left(3));
    var getStringName = main$getStringName;
  }
  ...
  Welcome.prototype.render_ss14n$ = function ($receiver) {
    ...
    var tmp$;
    $receiver_0.unaryPlus_pdl1vz$(' Your name backwards is ' + reversed(Kotlin.isCharSequence(tmp$ = $receiver_1) ? tmp$ : throwCCE()).toString() + '!');
